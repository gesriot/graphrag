...
`484 passed, 2 xfailed` for `PYTHONPATH=. uv run pytest examples -q`
(includes the documentation-consistency check and C preprocessor provenance tests).

**Live re-check (2026-07-26):** `484 passed, 2 xfailed`.
...
|---|---|---|
| Full examples suite | `PYTHONPATH=. uv run pytest examples -q` | **484 passed, 2 xfailed** |
