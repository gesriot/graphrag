...
1. Treat `PHASE5_REPORT.md` + `sqlparse.split` as the frozen Phase 5 evidence baseline, `examples/jsmn/PROVENANCE.md` as the Phase 6 first-C-port baseline, `examples/inih/PROVENANCE.md` as the second-C-port baseline, and `examples/cjson/PROVENANCE.md` as the third-C-port ownership baseline.
