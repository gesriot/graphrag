...
3. Decide the next frontier:
   ...
   - bounded cJSON float-printing fidelity (`%1.15g`/`%1.17g`, exponent/precision/NaN/inf) if the goal is to close the most visible cJSON caveat;
...
*Plan created: 2026-06-14. Reviewed/updated: 2026-06-27. Current implementation strategy: prove deterministic BYOG + local context packs on increasingly realistic Python targets, including data-heavy heuristic libraries, before expanding to C/C++, semantic overlays, or product packaging.*
